...
<body class="font-sans bg-gray-900 text-white">
    <nav class="border-b border-gray-800">
        <div class="sm:w-[90%] sm:ml-[5%] lg:w-[80%] lg:ml-[10%] flex flex-col md:flex-row items-center justify-between py-6 ">
            <ul class="flex items-center">
                <li>
                    <a href="/">
                        <svg class="w-24 sm:w-32" viewBox="0 0 96 24" fill="none">
